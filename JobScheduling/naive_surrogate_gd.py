...
def run_experiment():
    ...
    for total_run in range(ROUND_NUM):
        ...
        end_time = time.time()
        print(f"NativeSGD Run {total_run + 1} elapsed time: {end_time - start_time:.2f} seconds.")
    ...
    print(f"NativeSGD algorithm completed. Results saved to {output_path}")
